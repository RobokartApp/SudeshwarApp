...
public class PlayCheckAnswerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public PlayCheckAnswerAdapter(Context context, List<Question> recommendationsList) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PlayCheckAnswerAdapter.ViewHolder(
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            correctAnswersModelList = NewQuizActivity.correctAnswersList;

            try {
                final CorrectAnswersModel correctAnswersModel = PlayQuizActivity.correctAnswersList.get(position);
