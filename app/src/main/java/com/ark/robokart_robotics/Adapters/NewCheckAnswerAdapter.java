...
public class NewCheckAnswerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public NewCheckAnswerAdapter(Context context, List<Question> recommendationsList) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new NewCheckAnswerAdapter.ViewHolder(
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            try {
                final CorrectAnswersModel correctAnswersModel = NewQuizActivity.correctAnswersList.get(position);
