...
public class PlayQuizViewModel extends AndroidViewModel {

    private final com.ark.robokart_robotics.Activities.Quiz.PlayQuizRepository quizRepository;

    public PlayQuizViewModel(@NonNull Application application) {
        super(application);
        quizRepository = new PlayQuizRepository(application);
    }
