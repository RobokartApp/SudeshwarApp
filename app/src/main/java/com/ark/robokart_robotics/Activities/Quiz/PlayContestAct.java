...
public class PlayContestAct extends AppCompatActivity {
    ...
    private com.ark.robokart_robotics.Activities.Quiz.PlayContestViewModel quizViewModel;
    ...
    public void init() {
        ...
        quizViewModel = new ViewModelProvider(this).get(PlayContestViewModel.class);
...
//                startTimer();
        ...
        go_home_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(PlayContestAct.this, HomeActivity.class));
...
//                        Toast.makeText(getActivity(), e.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void submitQuizResult(String quiz_id, String customer_id,
        ...
        StringRequest request = new StringRequest(Request.Method.POST, ApiConstants.HOST + "submit_quiz_contest.php", response -> {
            try {
                JSONObject jsonObject = new JSONObject(response);
